		...
		<div class="breadcrumbs overlay">
			<div class="container">
				<div class="bread-inner">
					<div class="row">
						<div class="col-12">
							<h2>Ablaze Conference</h2>
							<ul class="bread-list">
								<li><a href="../index.php">Home</a></li>
								<li><i class="icofont-simple-right"></i></li>
								<li ><a href="../event.php">Events</a></li>
                                <li><i class="icofont-simple-right"></i></li>
                                <li class="../active">Ablaze Conference</li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="row">
							<div class="col-12">
								<div class="single-main">
									...
									<!-- News Title -->
									<h1 class="news-title"><a href="news-single.php">ABLAZE CONFERENCE</a></h1>
									<!-- Meta -->
									
									<!-- News Text -->
									<div class="news-text">
										<p>As the name implies, Ablaze Conference is a time of prayer, fasting, revival, and Bible study aimed at inflaming, kindling, and fueling the church of God's love, passion, and dedication to God. It is also a time when gifts and powers are stirred up, mantles are released, healing and deliverance are break forth, and the downtrodden and captives are set free. It is normally a four-day program. It begins on the Wednesday of the week it is planned to take place and ends on the Sunday.</p>
										
										<p>celebration and you’ll really enjoy every bit of the activities which are meant for holistic development The Ladies’ and Gents’ Wing Conference - LAGCON’23 is a week-long program of the church that is celebrated once every academic year, under the auspices of the Ladies’ and Gents’ Wings units of the Church. This wings as units of the church (PENSA LEGON) practically represent the PEMEM and WOMEN MINISTRIES of the church in our Local Assemblies of the Church of Pentecost. It focuses on providing varieties of activities geared towards holistic development of the youth in a changing world that’s coupled with a lot of demands. Some areas of focus are health, personal hygiene, skills training, interactive session with resident Pastor and wife, career guidance, among many others.</p>
						...
						<div class="main-sidebar">
							...
							<div class="single-widget category">
								...
								<ul class="categor-list">
									...
									<li><a href="ablaze.php" class="active">Ablaze Conference </a></li>
									<li><a href="discovery.php">Discovery for Excellence</a></li>
									<li><a href="#"></a></li>
								</ul>
							</div>
							<!--/ End Single Widget -->
